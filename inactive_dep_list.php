...
$url = "inactive_dep_list.php?id=$id&name=$name";
?>
  <p class="h2 mx-auto text-center mb-5"> Inactive <?php echo $name?> Department List </p>
  ...
  <div class="row">
    ...
    <form action="departments.php" method="get"><input type="hidden" name="id" value="<?php echo $id; ?>"> <input type="hidden" name="name" value="<?php echo $name; ?>"> 
      <button type="submit" class="btn btn-md btn-outline-dark"> Show Actives
    </button></form>
    </div>
    ...
    <tbody>
      <tr>
        ...
        <td class = "text-center"><form action="edit_deps.php" method="get"><input type="hidden" name="id" value="<?php echo $id; ?>"> <input type="hidden" name="name" value="<?php echo $name; ?>"><button type="submit" class="btn btn-sm btn-outline-primary">
              ...
              </svg> <span class="visually-hidden"></span></button></a></form></td>
        <td class = "text-center"><form action="depIsActive.php" method="get"  onclick="return confirm('are you sure?')"><input type="hidden" name="id" value="<?php echo $id; ?>"> <input type="hidden" name="url" value="<?php echo $url; ?>"><button type="submit" class="btn btn-sm btn-outline-success">
