...
<?php 
    ...
    if($results === false){
      ...
      $semester = mysqli_fetch_assoc($results);
      //var_dump($semester);
      
    }
?>
  <p class="h2 mx-auto text-center"> Semester Editing </p>
  ...
  <div class="container mt-5">
    <form method="post">
      ...
      <div class="col-md-4 mx-auto">
            <input type="text" class="form-control text-center" min="2000" placeholder= "<?= $semester['Semester'];?>" readonly>
          </div>
      </div>

      <div class="row">
        <div class="offset-2 col-md-4">
            <select class="form-control form-control-md text-center" name='Semester1'>
      ...
      <?php
        if(isset($_POST['update'])) // when click on Update button
        {
            ...
            $edit = mysqli_query($conn,"UPDATE `semesters` SET `Semester`='$Semester1' where SemesterID = '$id'");
...
<div class="row mx-auto mb-3 ">
      ...
      <a href="semesters.php"><button type="button" name="back" class="btn btn-md btn-outline-danger btn-md mt-4">Cancel</button></a>
        ...
        <div class="col-3 ml-auto mt-3">
          <button type="submit" name="update" class="btn btn-md btn-outline-primary btn-md mt-3">Save</button>
        </div>
      </div>
</div>
    </form> 
