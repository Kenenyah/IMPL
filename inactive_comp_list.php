...
<?php ob_start()?>
  <p class="h2 mx-auto text-center mb-5"> Inactive Company List </p>
  ...
  <form class="form-inline d-flex">
    ...
    <a href="create_company.php"><button type="button" class="btn btn-md btn-outline-success">
    ...
    <a href="company_list.php">
      <button type="button" class="btn btn-md btn-outline-dark"> Show Actives
</button></a>
      </form>
    </div>
</div>
      ...
      //ob_start();
       ...
       // $companies = mysqli_fetch_all($results, MYSQLI_ASSOC);
        ...
        <td class = "text-center"><form action="edit_company.php" method="get"><input type="hidden" name="id" value="<?php echo $id; ?>"><button type="submit" class="btn btn-sm btn-outline-primary">
              ...
              <td class = "text-center"><form action="isactive.php" method="get" onclick="return confirm('are you sure?')"><input type="hidden" name="id" value="<?php echo $id; ?>"><button type="submit" class="btn btn-sm btn-outline-success">
